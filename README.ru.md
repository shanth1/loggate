...
![Фильтры](docs/assets/filters.png)
![Дашбоард](docs/assets/dashboard.png)
...
| Раздел                                                     | Описание                                                                           |
| :--------------------------------------------------------- | :--------------------------------------------------------------------------------- |
| **[1. Архитектура](docs/01-architecture.ru.md)**           | Обзор компонентов системы, схемы взаимодействия и потока данных.                   |
| **[2. Установка и запуск](docs/02-getting-started.ru.md)** | Подробные инструкции по развертыванию для разработки и production.                 |
| **[3. Конфигурация](docs/03-configuration.ru.md)**         | Детальное описание всех конфигурационных файлов (`config.yaml`, `.env`, Promtail). |
| **[4. Администрирование](docs/04-administration.ru.md)**   | Задачи эксплуатации: мониторинг, резервное копирование, устранение неисправностей. |
| **[5. Разработка](docs/05-development.ru.md)**             | Руководство для контрибьюторов: структура проекта, добавление новых хранилищ.      |
